...
class AtpPlayerSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        #name
            ...
            name = self.get_formatted_name(origin_name)
        #age
        ...
        #next_pts
            ...
            next_pts = self.get_pts_int(next_pts_txt)
        #max_pts
            max_pts_txt = player_item.xpath('./td[14]/text()').extract_first().strip()
            max_pts = self.get_pts_int(max_pts_txt)
        #nicknames
            nickname = self.get_eng_name(origin_name)
